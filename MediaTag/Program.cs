...
public static class Program
{
    ...
    public static string Name { get; } = Assembly.GetName().Name ?? "MediaTag";
    ...
    public static string ProjectUrl { get; } = "https://github.com/itxconsider/MediaTag";
