...
{
    [Theory]
    [InlineData("https://www.dramaboxdb.com/ep/42000021382_deny-me-dragon-king/701326432_Episode-1", true)]
    ...
    public async Task QueryResolver_RoutesDramaBoxQuery()
    {
        ...
        var url = "https://www.dramaboxdb.com/ep/42000021382_deny-me-dragon-king/701326432_Episode-1";
    ...
    public async Task DramaBoxQueryResolver_ResolvesSeriesPlaylist()
    {
        ...
        Assert.True(result.Videos.Count > 1, $"Expected multiple episodes in playlist, found {result.Videos.Count}");
    ...
    {
        var url = "https://www.dramaboxdb.com/ep/42000021382_deny-me-dragon-king/701326432_Episode-1";
        var streamUrl = await DramaBoxQueryResolver.TryExtractStreamUrlAsync(url);
    ...
    public async Task DramaBoxQueryResolver_DifferentiatesUnlockedAndLockedEpisodes()
    {
        ...
        var ep1Result = await resolver.ResolveAsync("https://www.dramaboxdb.com/ep/42000021382_deny-me-dragon-king/701326432_Episode-1");
        ...
        var ep13Result = await resolver.ResolveAsync("https://www.dramaboxdb.com/ep/42000021382_deny-me-dragon-king/701326444_Episode-13");
