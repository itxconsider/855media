...
{
    private const string BundleName = "855Media.app";
    private const string AppName = "855Media";
    private const string AppExecutableName = "855Media";
    private const string AppCopyright = "© Oleksii Holub";
    private const string AppIdentifier = "me.855Media";
    private const string AppSpokenName = "855Media";
