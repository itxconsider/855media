...
public partial class LocalizationManager
{
    private static readonly IReadOnlyDictionary<string, string> EnglishLocalization =
        new Dictionary<string, string>
        {
            ...
            [nameof(SingleDownloadTabTitle)] = "Single Download",
            [nameof(BatchDownloadTabTitle)] = "Batch",
            [nameof(DownloadsManagerTabTitle)] = "Manager",
            [nameof(HistoryTabTitle)] = "History",
            [nameof(ClearHistoryTitle)] = "Clear History",
            [nameof(ClearHistoryMessage)] = "Are you sure you want to clear all download history?",
            [nameof(ClearHistoryButton)] = "Clear History",
            [nameof(ExportHistoryTitle)] = "Export History",
            [nameof(ExportHistoryButton)] = "Export",
            [nameof(HistoryClearedSnackbar)] = "Download history cleared.",
            [nameof(HistoryExportedSnackbar)] = "Download history exported successfully.",
            [nameof(FileNotFoundMessage)] = "The specified file could not be found on disk.",
            [nameof(SearchHistoryPlaceholder)] = "Search history by title, channel, or URL...",
            [nameof(NoHistoryRecords)] = "No download history entries found.",
            [nameof(RetryButton)] = "Retry",
            ...
            [nameof(DramaBoxTabTitle)] = "DramaBox",
            [nameof(UpscalerTabTitle)] = "Upscaler",
            ...
            [nameof(DramaBoxPromptTitle)] = "Download DramaBox Dramas & Episodes",
            [nameof(YouTubeWatermark)] = "Paste YouTube URL or enter search query...",
            [nameof(TikTokWatermark)] = "Paste TikTok video or slideshow URL...",
            [nameof(FacebookWatermark)] = "Paste Facebook photo album or video post URL...",
            [nameof(DramaBoxWatermark)] = "Paste DramaBox movie, series, or episode URL...",
            [nameof(StatusFilterAll)] = "All",
            [nameof(StatusFilterActive)] = "Downloading",
            [nameof(StatusFilterCompleted)] = "Completed",
            [nameof(StatusFilterFailed)] = "Failed",
            [nameof(BatchInputPlaceholder)] = "Paste your URLs here (one URL per line)...",
            [nameof(ProcessBatchButton)] = "Process Batch Downloads",
            [nameof(DashboardPromptTitle)] = "What would you like to download?",
            ...
            [nameof(VideoTypeLabel)] = "Video type",
            [nameof(ListViewTooltip)] = "List view",
            [nameof(GridViewTooltip)] = "Grid view",
